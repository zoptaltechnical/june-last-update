...
- (void)viewDidLoad {
    ...
    oldPaswrdTxtFld.layer.cornerRadius = 15.0;
...
-(void)changePasswordValidation
{
    ...
    if ([[oldPaswrdTxtFld.text stringByReplacingOccurrencesOfString:@" " withString:@""] length] == 0)
    {
        ...
        [oldPaswrdTxtFld resignFirstResponder];
        [newPaswrdTxtFld resignFirstResponder];
        [cnfrmPasswrdTxtFld resignFirstResponder];
